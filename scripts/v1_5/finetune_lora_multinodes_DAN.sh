...
VISION=/lustre/orion/csc538/scratch/alexisroger/hf_cache/vit_large_patch14_dinov2.lvd142m
...
deepspeed \
    ...
    --pretrain_mm_mlp_adapter /lustre/orion/csc538/scratch/$(whoami)/checkpoints/robin_v2/pretrain/checkpoint-500/mm_projector.bin \
...
# tune vision encoder learning rate
