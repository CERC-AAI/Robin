...
class LlavaNeoxPipeline:
    def __init__(self, model_path, model_base, device="cuda", load_8bit=False, load_4bit=False, temperature=.2, max_new_tokens=512):
        ...
        self.tokenizer, self.model, self.image_processor, context_len = load_pretrained_model(self.model_path, self.model_base, self.model_path, self.load_8bit, self.load_4bit, device=self.device)
